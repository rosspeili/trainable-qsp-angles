...
\begin{tabularx}{\textwidth}{@{} l l X @{}}
  ...
  \bottomrule
\end{tabularx}
\caption{Technology stack. All components interoperate through JAX's functional transformation interface~\cite{peili_demo_2026}.}
\label{tab:stack}
\end{table}
